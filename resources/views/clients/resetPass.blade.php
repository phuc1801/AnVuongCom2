...
<body>
    <div class="wrapper">
        <form action="{{ route('password.update') }}" method="POST" id="reset-form">
            @csrf
            <h2 class="glow-text">Đổi mật khẩu</h2>
            ...
            <button class="submit-btn" type="submit">Đổi mật khẩu</button>
        </form>
    </div>
    ...
    <script src="{{ asset('assets/clients/js/login/reset_pass.js') }}"></script>
